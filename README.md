...
```sh
grep -rl 'md5' ./ | xargs sed -i '' 's/md5/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with md5
...
Want to contribute? Ping us on `md5` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/md5.git
    cd md5
    ```
...
- [md5 integration Documentation](https://docs.vuestorefront.io/md5)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `md5` channel on [our Discord](discord.vuestorefront.io).
