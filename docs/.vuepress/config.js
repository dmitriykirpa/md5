module.exports = {
  title: 'Vue Storefront 2 for md5',
  base: '/',
  description: 'Documentation for the md5 connector for Vue Storefront 2',
  head: [
  ...
  themeConfig: {
    repo: 'https://github.com/vuestorefront/md5',
    editLinks: true,
    docsDir: 'docs',
    docsBranch: 'develop',
    ...
    nav: [
      ...
      // { text: 'Demo', link: '' },
      { text: 'GitHub', link: 'https://github.com/vuestorefront/md5'},
      { text: 'Roadmap', link: 'https://github.com/vuestorefront/md5'}
    ],
    sidebar: [
      {
        title: 'Essentials',
